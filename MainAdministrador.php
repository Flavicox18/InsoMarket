...
<body>
    <div id="main-administrador">
        ...
        <div class="container">
            <h1>¡Bienvenido Administrador XXXXXX!</h1>
            <br>
            <div class="row">
                <div class="col-md-4 centered-content">
                    <a href="GestionarDelivery.php" class="opcMain imgCambiante">
                        <img src="img/GestionarDeliveryNegro.png" alt="">
                        <h3>Gestionar Delivery</h3>
                    </a>
                </div>
                <div class="col-md-4 centered-content">
